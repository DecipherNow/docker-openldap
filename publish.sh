...
docker push "deciphernow/openldap:${MAJOR}"
docker push "deciphernow/openldap:${MAJOR}.${MINOR}"
docker push "deciphernow/openldap:${MAJOR}.${MINOR}.${PATCH}"

docker rmi "${BUILD_TAG}"

echo "Built, tagged and pushed the following images:"
